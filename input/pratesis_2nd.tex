...
\end{tabular}
dengan ini mengajukan permohonan ujian Pra-Tesis\soutthick{/Tesis} saya yang berjudul:
...
\newgeometry{top=1.5cm,bottom=.7cm}
\newpage
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%% PERNYATAAN PENGAJUAN PUBLIKASI
\newpage
\begin{center}
...
\item Berkala MIPA 
\item Lainnya (sebutkan) \Pointilles[0.1]{1}
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%% Surat pernyataan pembuatan program
\newpage
\begin{center}
